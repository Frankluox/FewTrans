...
class MultiModalPromptLearner(nn.Module):
    ...
    def forward(self, dataset_idx = 0):
        ctx = self.ctx
...
class CustomCLIP(nn.Module):
    ...
    def forward(self, image, label=None, dataset_idx = 0, training = False, class_ids = None):
        ...
        prompts, shared_ctx, deep_compound_prompts_text, deep_compound_prompts_vision = self.prompt_learner(dataset_idx)
...
def create_model(all_classnames, mode = "MaPLe", backbone_name="ViT-B/16", img_sz=224):
