...
def swin_base_patch4_window7_224():
    return SwinTransformer(embed_dim=128, depths=[2, 2, 18, 2], num_heads=[4, 8, 16, 32], window_size=7, drop_path_rate=0.5)

def swin_tiny_window7_224(window_size=7, **kwargs):
...
def swin_small_window7_224(window_size=7, **kwargs):
    model = SwinTransformer(
