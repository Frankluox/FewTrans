...
# all_roots["ILSVRC"] = "/dev/shm/ImageNet_train"
# all_roots["ILSVRC"] = "/home/wuhao/data/imagenet/val" #0
all_roots["ILSVRC"] = os.path.join(DATA_ROOT, "ImageNet_sketch")
...
Data["DATA"]["TEST"]["EPISODE_DESCR_CONFIG"]["NUM_TASKS_PER_EPOCH"] = 2
Data["PRINT_FREQ"] = 10
