...
_C.DATA.BASE2NOVEL = False
_C.DATA.CROSS_DATASET = False
_C.DATA.TRAIN = CN()
...
_C.DATA.TRAIN.EPISODE_DESCR_CONFIG.NUM_QUERY_BASE = 15
_C.DATA.TRAIN.EPISODE_DESCR_CONFIG.NUM_QUERY_NOVEL = 15
#========================================================================================
...
_C.DATA.TRAIN.EPISODE_DESCR_CONFIG.MIN_WAYS = 2
# maximum ways to sample
_C.DATA.TRAIN.EPISODE_DESCR_CONFIG.MAX_WAYS_UPPER_BOUND = 500
...
_C.DATA.TRAIN.EPISODE_DESCR_CONFIG.MAX_SUPPORT_SIZE_CONTRIB_PER_CLASS = 10
...
_C.DATA.TEST.EPISODE_DESCR_CONFIG.NUM_QUERY_BASE = None
_C.DATA.TEST.EPISODE_DESCR_CONFIG.NUM_QUERY_NOVEL = 15
...
_C.DATA.TEST.EPISODE_DESCR_CONFIG.SAMPLE_ALL = 0
...
_C.AUG.COLOR_JITTER = [0.4,0.4,0.4,0,1]
...
_C.SEARCH_HYPERPARAMETERS.BASE_ONLY = False
